    ...
    <div class="container-fluid">
     ...
     <table class="table mt-8 responsive" id="example">
        <thead>
            ...
            <th scope="col">Days since tweet</th>
            <th scope="col">Username</th>
            <th scope="col">Tweet</th>
            <th scope="col">Retweet Count</th>
            <th scope="col">Tweet favourited</th>
...
<div class="container" id="editmodal">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form method="POST" action="/twittertweetsavechanges">
                      <div class="mb-3">
 ...
 $('#example').DataTable( {  
    ...
    "serverMethod":"POST",
     ...
     "columns": [
         ...
         { data: "twitterhandel" },
         { data: "days_since_tweet" },
         { data: "username_at_the_rate" },
         { data: "tweet" },
         { data: "retweet_count" },
         { data: "tweet_favourited" },
...
<script>
  $(document).ready(function(){
    $(".downentirebtn").on("click",function(){
      window.location.replace("/downloadcompletetwittertweetsdata")
    });
  });
</script>
<!-- 
