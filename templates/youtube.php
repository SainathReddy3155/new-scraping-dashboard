...
.downloadyoutubedownloadexcel{
  background-color:#702963!important;
  border: #702963!important;
}
.downloadyoutubedownloadexcel:hover{
    box-shadow: 2px 2px 8px rgba(-2, 10, 10, 2);
}
    ...
    <div id="loader"  style="display:none;">
      ...
      <div class="row">
        <div class="col-lg-6 col-sm-6">
            ...
            <button class="btn btn-primary downloadyoutubedownloadexcel"><i class="fa-sharp fa-solid fa-download"></i> Download excel</button>
        </div>
...
<div class="container" id="editmodal">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form method="POST" action="/linkedinbasicinfosavechanges">
                      <div class="mb-3">
                        <label for="name" class="form-label"><b>Name</b></label>
                        <input type="text" class="form-control" id="name" name="name" aria-describedby="Name" readonly >
                      </div>
                      <div class="mb-3">
                        <label for="Video Name" class="form-label"><b>Video Name</b></label>
                        <textarea type="text" class="form-control" id="VideoName" name="Videoname" aria-describedby="Video Name" rows="4" cols="50" readonly></textarea>
                       
                      </div>
                      <div class="mb-3">
                        <label for="Views" class="form-label"><b>Views</b></label>
                        <input type="text" class="form-control" id="Views" name="views" aria-describedby="Views" >
                      </div>
                      <div class="mb-3">
                        <label for="dateposted" class="form-label"><b>Date Posted</b></label>
                        <input type="text" class="form-control" id="dateposted" name="Dateposted" aria-describedby="Dateposted" >
                      </div>
                      <div class="mb-3">
                        <label for="Likes" class="form-label"><b>Likes</b></label>
                        <input type="text" class="form-control" id="Likes" name="likes" aria-describedby="Likes" >
                      </div>
                      <div class="mb-3">
                        <label for="Channel name" class="form-label"><b>Channel name</b></label>
                        <input type="text" class="form-control" id="channelname" name="Channelname" aria-describedby="Channelname" readonly>
                      </div>
                      <div class="mb-3">
                        <label for="Subscribers" class="form-label"><b>Subscribers</b></label>
                        <input type="text" class="form-control" id="Subscribers" name="subscribers" aria-describedby="Subscribers" >
                      </div>
                      <div class="mb-3">
                      ...
                      <div class="mb-3">
                        <label for="VideoUrl" class="form-label"><b>Video Url</b></label>
                        <input type="text" class="form-control" id="VideoUrl" name="Videourl" aria-describedby="VideoUrl" readonly>
                      </div>
...
<div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="mb-3">
                        <label for="linkedininfo" class="form-label"><b>Permanently Delete Linkedin Info</b></label>
...
<script>
  $(document).ready(function(){
    $(".downloadyoutubedownloadexcel").on("click",function(){
      window.location.replace("/youtubedownloadexcel")
    });
  });
</script>
...
<script>
    $('#example').on('click', 'td.editor-edit', function (e) {
        ...
        var td=tr.find("td")
        var name=$(td[0]).text()
        var videoname=$(td[1]).text()
        var views=$(td[2]).text()
        var dateposted=$(td[3]).text()
        var likes=$(td[4]).text()
        var channelname=$(td[5]).text()
        var subs=$(td[6]).text()
        var comments=$(td[7]).text()
        var videourl=$(td[8]).text()
        $("#name").attr("value",name)
        $("#VideoName").html(videoname)
        $("#Views").attr("value",views)
        $("#dateposted").attr("value",dateposted)
        $("#Likes").attr("value",likes)
        $("#channelname").attr("value",channelname)
        $("#Subscribers").attr("value",subs)
        $("#Comments").attr("value",comments)
        $("#VideoUrl").attr("value",videourl)
