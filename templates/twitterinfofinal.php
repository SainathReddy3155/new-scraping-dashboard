...
<body class="fixed-nav sticky-footer bg-light" id="page-top">
  ...
  <div class="card-body">
    ...
    <form id="tweetsearch" method="POST">
      <b>Handle : </b><input type="text" name="name" class="handle" id="twitterhandle"  placeholder="Enter Twitter Handle" required>
    ...
    <div id="loader"  style="display:none;">
     ...
     <table class="table mt-8 responsive" id="example">
        <thead>
            ...
            <th scope="col">Tweets per day</th>
...
<div class="container" id="editmodal">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form method="POST" action="/twitterinfosavechanges">
                      <div class="mb-3">
                        <label for="TwitterHandel" class="form-label"><b>Twitter handel</b></label>
                        <input type="text" class="form-control" id="Twitterhandel" name="twitterhandel" aria-describedby="Specialization" readonly>
                      </div>
                      <div class="mb-3">
                        <label for="totaltweets" class="form-label"><b>Total tweets</b></label>
                        <input type="text" class="form-control" id="totaltweets" name="totaltweets" aria-describedby="totaltweets" >
                       
                      </div>
                      <div class="mb-3">
                        <label for="Tweets per day" class="form-label"><b>Tweets per day</b></label>
                        <input type="text" class="form-control" id="tweetsprday" name="Tweetsperday" aria-describedby="Tweetsperday" >
                      </div>
                      <div class="mb-3">
                        <label for="Followers" class="form-label"><b>Followers</b></label>
                        <input type="text" class="form-control" id="followers" name="followers" aria-describedby="Followers" >
                      </div>
                      <div class="mb-3">
                        <label for="Following" class="form-label"><b>Following</b></label>
                        <input type="text" class="form-control" id="following" name="following" aria-describedby="Following" >
                      </div>
                      <div class="mb-3">
                        <label for="Favourited" class="form-label"><b>Favourited</b></label>
                        <input type="text" class="form-control" id="favourited" name="favourited" aria-describedby="Favourited" >
                      </div>
...
<script>
  $(document).ready(function(){
    $(".downentirebtn").on("click",function(){
      window.location.replace("/downloadcompletetwitterinfo")
    });
  });
</script>
...
<script>
    $('#example').on('click', 'td.editor-edit', function (e) {
        ...
        var tr=$(this).closest("tr")
        var td=tr.find("td")
        var twitterhandel=$(td[0]).text()
        var totaltweets=$(td[1]).text()
        var tweetsperday=$(td[2]).text()
        var followers=$(td[3]).text()
        var following=$(td[4]).text()
        var favourited=$(td[5]).text()
        $("#Twitterhandel").attr("value",twitterhandel)
        $("#totaltweets").attr("value",totaltweets)
        $("#tweetsprday").attr("value",tweetsperday)
        $("#followers").attr("value",followers)
        $("#following").attr("value",following)
        $("#favourited").attr("value",favourited)
    } );
</script>
