  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-xl-3 col-sm-6 mb-3">
          <div class="card text-black o-hidden h-100">
            <div class="card-body">
              ...
              <div class="text-center mr-5 "><b><i class="fa-solid fa-user-doctor"></i> Total Doctors</b></br>
              <span class="text-center fs-2"><b>{{variable.total_docs}}</b></span>
              </div>
            </div>
        ...
        <div class="col-xl-3 col-sm-6 mb-3">
          <div class="card text-black  o-hidden h-100">
            <div class="card-body">
              ...
              <div class="text-center mr-5"><b><i class="fa-brands fa-google" style="color:#3cba54"></i> Total Google Data</b></br>
              <span class="text-center fs-2"><b>{{variable.total_gmbdetails}}</b></span>
              </div>
            </div>
        ...
        <div class="col-xl-3 col-sm-6 mb-3">
          <div class="card text-black  o-hidden h-100">
            <div class="card-body">
              ...
              <div class="text-center mr-5"><b><i class="fa-brands fa-twitter" style="color:#1DA1F2"></i> Total Twitter Data</b></br>
              <span class="text-center fs-2"><b>{{variable.total_twitter_info}}</b></span>
              </div>
            </div>
        ...
        <div class="col-xl-3 col-sm-6 mb-3">
          <div class="card text-black font-weight-bold  o-hidden h-100">
            <div class="card-body">
              <div class="card-body-icon">
                <!-- <i class="fa fa-fw fa-support"></i> -->
              </div>
              <div class="text-center mr-5"><b><i class="fa-brands fa-linkedin" style="color:#0e76a8;"></i> Total Linkedin Data</b></br>
              <span class="text-center fs-2"><b>{{variable.total_linkedin}}</b></span>
              </div>
            </div>
      ...
      <div class="col-xl-3 col-sm-6 mb-3">
          <div class="card text-black  o-hidden h-100">
            <div class="card-body">
              ...
              <div class="text-center mr-5"><b><i class="fa-solid fa-stethoscope" style="color:blue;"></i> Total Aggregator Data</b></br>
              <span class="text-center fs-2"><b>{{variable.total_practodata}}</b></span>
              </div>
            </div>
