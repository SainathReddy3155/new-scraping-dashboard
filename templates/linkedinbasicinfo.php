...
.downloadlinkedinbasicinfo{
  background-color:#702963!important;
  border: #702963!important;
}
.downloadlinkedinbasicinfo:hover{
    box-shadow: 2px 2px 8px rgba(-2, 10, 10, 2);
}
#linkedinsearchbtn{
    background-color:#702963!important;
    ...
    <div id="loader"  style="display:none;">
      ...
      <div class="row">
        <div class="col-lg-6 col-sm-6">
            ...
            <button class="btn btn-primary downloadlinkedinbasicinfo"><i class="fa-sharp fa-solid fa-download"></i> Download excel</button>
        </div>
    ...
    <div class="modal-content">
      ...
      <form method="POST" action="/linkedinbasicinfosavechanges">
                      <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="linkedinname" name="linkedin_name" aria-describedby="Name" readonly>
                      </div>
                      <div class="mb-3">
                      ...
                      <div class="mb-3">
                        <label for="Connections" class="form-label"><b>Connections</b></label>
                        <input type="text" class="form-control" id="Connections" name="connections" aria-describedby="Connections" >
                      </div>
                      <div class="mb-3">
                        <label for="About" class="form-label"><b>About</b></label>
                        <textarea type="text" class="form-control" id="About" name="about" aria-describedby="	About"  rows="4" cols="50"></textarea>
                      </div>
                      <div class="mb-3">
                      ...
                      <div class="mb-3">
                        <label for="LinkedinUrl" class="form-label"><b>Linkedin url</b></label>
                        <input type="text" class="form-control" id="Linkedinurl" name="linkedinurl" aria-describedby="LinkedinUrl" readonly>
                      </div>
...
<script>
  $(document).ready(function(){
    $(".downloadlinkedinbasicinfo").on("click",function(){
      window.location.replace("/downloadlinkedinbasicinfoexcel")
    });
  });
</script>
...
<script>
    $('#example').on('click', 'td.editor-edit', function (e) {
        ...
        var description=$(td[1]).text()
        var location=$(td[2]).text()
        var connections=$(td[3]).text()
        var about=$(td[4]).text()
        ...
        $("#Connections").attr("value",connections)
        $("#About").html(about)
        $("#Followers").attr("value",followers)
        $("#Linkedinurl").attr("value",linkedinurl)
