...
.downloadlinkedinarticles{
  background-color:#702963!important;
  border: #702963!important;
}
.downloadlinkedinarticles:hover{
    box-shadow: 2px 2px 8px rgba(-2, 10, 10, 2);
}
#linkedinsearchbtn{
    background-color:#702963!important;
    ...
    <div id="loader"  style="display:none;">
      ...
      <div class="row">
        <div class="col-lg-6 col-sm-6">
            ...
            <button class="btn btn-primary downloadlinkedinarticles"><i class="fa-sharp fa-solid fa-download"></i> Download excel</button>
        </div>
...
<script>
  $(document).ready(function(){
    $(".downloadlinkedinarticles").on("click",function(){
      window.location.replace("/downloadlinkedinarticlesexcel")
    });
  });
</script>
