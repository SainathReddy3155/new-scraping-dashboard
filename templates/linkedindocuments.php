...
.downloadlinkedindocuments{
  background-color:#702963!important;
  border: #702963!important;
}
.downloadlinkedindocuments:hover{
    box-shadow: 2px 2px 8px rgba(-2, 10, 10, 2);
}
#linkedinsearchbtn{
    background-color:#702963!important;
      ...
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        ...
        <li class="nav-item" data-bs-toggle="tooltip" data-placement="right" title="Components">
          ...
          <ul class="sidenav-second-level collapse" id="collapseComponents">
            <li>
              <a href="/twitterinfofinal" class="twitterinner">Twitter Info</a>
            </li>
            <li>
    ...
    <div id="loader"  style="display:none;">
      ...
      <div class="row">
        <div class="col-lg-6 col-sm-6">
            ...
            <button class="btn btn-primary downloadlinkedindocuments"><i class="fa-sharp fa-solid fa-download"></i> Download excel</button>
        </div>
...
<div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="mb-3">
                        <label for="linkedininfo" class="form-label"><b>Permanently Delete Linkedin Document Data</b></label>
...
$(document).ready(function() {
 ...
 $('#example').DataTable( {  
    ...
    "serverMethod":"POST",
     ...
     ajax: {
        url: '/linkedindocumentsdatatable',
     },
     searching:true,
     sort:false,
...
<script>
  $(document).ready(function(){
    $(".downloadlinkedindocuments").on("click",function(){
      window.location.replace("/downloadlinkedindocumentsexcel")
    });
  });
</script>
