...
<!--end of datatable excel cdns-->
<!-- datatable excel buttons stylesheet links-->
<script src="https://cdn.datatables.net/1.13.1/css/jquery.dataTables.min.css"></script>
<script src="https://cdn.datatables.net/buttons/2.3.2/css/buttons.dataTables.min.css"></script>
<!-- end of datatable excel buttons stylesheet links-->
...
<body class="fixed-nav sticky-footer bg-light" id="page-top">
  ...
  <div class="card-body">
    ...
    <form id="gmbsearch" method="POST">
      <b>Google : </b><input type="text" name="name" class="handle searchbar" id="gmbkeywords"  placeholder="Enter Keywords" required>
    ...
    <div id="loader"  style="display:none;">
      ...
      <div class="row">
        ...
        <div class="col-lg-6 col-sm-6">
            ...
            <button class="btn btn-primary downloadcompletegmb"><i class="fa-sharp fa-solid fa-download"></i> Download excel</button>
        </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form method="POST" action="/gmbsavechanges">
                      <div class="mb-3">
                        <label for="Gmbname" class="form-label"><b>Name</b></label>
                        <input type="text" class="form-control" id="Gmbname" name="gmbname" aria-describedby="Gmbname" readonly>
                      </div>

                      <div class="mb-3">
                        <label for="GmbRating" class="form-label"><b>Rating</b></label>
                        <input type="text" class="form-control" id="Gmb_Rating" name="gmbrating" aria-describedby="Gmb_Rating">
                      </div>
                      <div class="mb-3">
                        <label for="Totalreviews" class="form-label"><b>Total reviews</b></label>
                        <input type="text" class="form-control" id="TotalReviews" name="totalreviews" aria-describedby="Total_Reviews" >
                      </div>
                      <div class="mb-3">
                        <label for="Speciality" class="form-label"><b>Speciality</b></label>
                        <input type="text" class="form-control" id="Speciality" name="speciality" aria-describedby="Speciality" >
                       
                      </div>
                      <div class="mb-3">
                        <label for="Address" class="form-label"><b>Address</b></label>
                        <textarea type="text" class="form-control" id="Address" name="address" rows="4" cols="50" aria-describedby="Address" ></textarea>
                      </div>
                      <div class="mb-3">
                        <label for="Phonenumber" class="form-label"><b>	Phone number</b></label>
                        <input type="text" class="form-control" id="Phonenumber" name="phonenumber" aria-describedby="Phonenumber" >
                      </div>
...
<div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="mb-3">
                        <label for="Gmb Name" class="form-label"><b>Permanently Delete Google Name</b></label>
...
<script>
    $('#example').on('click', 'td.editor-edit', function (e) {
        ...
        var td=tr.find("td")
        var gmbname=$(td[0]).text()
        var gmbrating=$(td[1]).text()
        var totalreviews=$(td[2]).text()
        var speciality=$(td[3]).text()
        var Address=$(td[4]).text()
        var phno=$(td[5]).text()
        console.log(name)
        $("#Gmbname").attr("value",gmbname)
        $("#Gmb_Rating").attr("value",gmbrating)
        $("#TotalReviews").attr("value",totalreviews)
        $("#Speciality").attr("value",speciality)
        $("#Address").html(Address)
        $("#Phonenumber").attr("value",phno)
    } );
</script>
