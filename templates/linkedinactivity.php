...
.downloadlinkedinactivitydownload{
  background-color:#702963!important;
  border: #702963!important;
}
.downloadlinkedinactivitydownload:hover{
    box-shadow: 2px 2px 8px rgba(-2, 10, 10, 2);
}
#linkedinsearchbtn{
    background-color:#702963!important;
    ...
    <div id="loader"  style="display:none;">
      ...
      <div class="row">
        <div class="col-lg-6 col-sm-6">
            ...
            <button class="btn btn-primary downloadlinkedinactivitydownload"><i class="fa-sharp fa-solid fa-download"></i> Download excel</button>
        </div>
    ...
    <div class="modal-content">
      ...
      <form method="POST" action="/linkedinbasicinfosavechanges">
                      ...
                      <div class="mb-3">
                        ...
                        <textarea type="text" class="form-control" id="postdata" name="postdata" aria-describedby="postdata" rows="4" cols="50" ></textarea>
...
<script>
  $(document).ready(function(){
    $(".downloadlinkedinactivitydownload").on("click",function(){
      window.location.replace("/downloadlinkedinactivitydownloadexcel")
    });
  });
</script>
