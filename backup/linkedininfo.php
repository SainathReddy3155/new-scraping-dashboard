      ...
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        ...
        <li class="nav-item" data-bs-toggle="tooltip" data-placement="right" title="Example Pages">
          ...
          <ul class="sidenav-second-level collapse" id="collapseExamplePages">
            ...
            <li>
              <a href="/linkedinposts?pgno=0" class="linkedininner">Linkedin Articles</a>
            </li>
            <li>
...
<script>
  $(document).ready(function(){
      ...
      if (urlerrorpgno){
        window.location.replace("/linkedinbasicinfo?pgno=0")
      }
  ...
  $(document).ready(function(){
    $("#previous").on("click",function(){
      ...
      if(pgno=='0'){
        ...
        window.location.replace('/linkedinbasicinfo?pgno='+pgno)
      }
