        ...
        <li class="nav-item" data-bs-toggle="tooltip" data-placement="right" title="Example Pages">
          ...
          <ul class="sidenav-second-level collapse" id="collapseExamplePages">
            <li>
              ...
              <a href="#" class="linkedininner">Linkedin Basic Info</a>
            </li>
            <li>
              <a href="#" class="linkedininner">Linkedin Activity</a>
            </li>
            <li>
              <a href="#" class="linkedininner">Linkedin Posts</a>
            </li>
            <li>
              <a href="#" class="linkedininner">Linkedin Articles</a>
            </li>
            <li>
              <a href="#" class="linkedininner">Linkedin Documents</a>
            </li>
          </ul>
        </li>
