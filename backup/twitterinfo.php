    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        ...
        <li class="nav-item" data-bs-toggle="tooltip" data-placement="right" title="Tables">
          <a class="nav-link" href="/practofinal">
    ...
    <div id="loader"  style="display:none;">
      ...
      <div class="row">
        <div class="col-lg-6 col-sm-6">
            <button class="btn btn-primary downsinglebtn"><i class="fa-sharp fa-solid fa-download"></i> Download This page</button>
            <button class="btn btn-primary downentirebtn"><i class="fa-sharp fa-solid fa-download"></i> Download entire table</button>
        </div>
        <div class="col-lg-6 col-sm-6 col-md-6 searchbtn d-flex">
            <b>Search :</b> <input type="text">&nbsp;
            <button class="btn btn-primary twitterinfosearchbtn">Search</button>
        </div>
</div>
    ...
    $(document).ready(function(){
        $("#previous").on("click",function(){
                ...
                if(pgno=='0'){
                    ...
                    console.log(pgno)
                    window.location.replace('/twitter?pgno='+pgno)
                }
        });
    });
</script>
...
<script>
    $(document).ready(function(){
        $(".edit").on("click",function(){
            ...
            console.log(value)
            $.ajax({
                url:"/twitterinfochanges",
                type:"POST",
                data:JSON.stringify({'data':value}),
                contentType:"application/json",
                success:function(response){
                    console.log("success");
                    var name=response['success'][1]
                    var twitterhandel=response['success'][2]
                    var totaltweets=response['success'][3]
                    var tweetsperday=response['success'][4]
                    var followers=response['success'][5]
                    var following=response['success'][6]
                    var favourited=response['success'][7]
                    var modal=`<form method="POST" action="#">
                      <div class="mb-3">
                        <label for="name" class="form-label"><b>Name</b></label>
                        <input type="text" class="form-control" name="name" readonly required aria-describedby="name" value='`+name+`'>
                      </div>
        
                      <div class="mb-3">
                        <label for="twitterhandel" class="form-label"><b>Twitter Handel</b></label>
                        <input type="text" class="form-control" id="twitterhandel" readonly required aria-describedby="twitterhandel" value='`+twitterhandel+`'>
                      </div>
                      <div class="mb-3">
                        <label for="totaltweets" class="form-label"><b>Total Tweets</b></label>
                        <input type="text" class="form-control" id="totaltweets" required aria-describedby="totaltweets" value='`+totaltweets+`'>
                      </div>
                      <div class="mb-3">
                        <label for="tweetsperday" class="form-label"><b>Tweets per Day</b></label>
                        <input type="text" class="form-control" required name="tweetsperday" aria-describedby="tweetsperday" value='`+tweetsperday+`'>
                       
                      </div>
                      <div class="mb-3">
                        <label for="followers" class="form-label"><b>Followers</b></label>
                        <input type="text" class="form-control" id="followers" required aria-describedby="followers" value='`+followers+`'>
                      </div>
                      <div class="mb-3">
                        <label for="following" class="form-label"><b>Following</b></label>
                        <input type="text" class="form-control" id="following" required aria-describedby="following" value='`+following+`'>
                      </div>
                      <div class="mb-3">
                        <label for="favourited" class="form-label"><b>Favourited</b></label>
                        <input type="text" class="form-control" id="favourited" required aria-describedby="favourited" value='`+favourited+`'>
                      </div>
...
<script>
  $(document).ready(function(){
    $(".downsinglebtn").on("click",function(){
        console.log("btn clicked");
        var pgno='{{variable.pgno}}';
        window.location.replace("/downsingletwitterexcel?pgno="+pgno)
    });
  });
</script>
