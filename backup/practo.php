...
<body class="fixed-nav sticky-footer bg-light" id="page-top">
  ...
  <div class="card-body">
    ...
    <form id="tweetsearch" method="POST">
      <b>Keywords : </b><input type="text" name="keywords" class="practokeyword" id="practokeywords"  placeholder="Enter Keywords for Practo" required>
...
<b><span id="successmessage" style="font-weight:600;font-"><span></b>
    <div id="loader"  style="display:none;">
      ...
      <div class="row">
        <div class="col-lg-12 col-sm-12 col-md-12 col-xl-12"><!-- change to col-lg-8 if u want bar chart card also for only table make it col-lg-12-->
      ...
      <div class="row">
        <div class="col-lg-6 col-sm-6">
            <button class="btn btn-primary downloadsinglepracto"><i class="fa-sharp fa-solid fa-download"></i> Download This page</button>
            <button class="btn btn-primary downloadallpracto"><i class="fa-sharp fa-solid fa-download"></i> Download entire table</button>
        </div>
        <div class="col-lg-6 col-sm-6 col-md-6 searchbtn d-flex">
            <b>Search :</b> <input type="text">&nbsp;
            <button class="btn btn-primary practoformsearch">Search</button>
        </div>
</div>
...
<div class="container-fluid"> <!-- If Needed Left and Right Padding in 'md' and 'lg' screen means use container class -->
    ...
    {%for data in variable.results%}
            ...
            <td>{{data[1]}}</td>
            <td>{{data[2]}}</td>
            <td class="Specialization">{{data[3]}}</td>
            <td>{{data[4]}}</td>
            <td>{{data[5]}}</td>
            <td>{{data[6]}}</td>
            <td class="education">{{data[7]}}</td>
            <td class="experience">{{data[8]}}</td>
            <td class="Registrations">{{data[9]}}</td>
            <td>{{data[10]}}</td>
            <td class="url">{{data[11]}}</td>
            <td class="url">{{data[12]}}</td>
    ...
    $(document).ready(function(){
        $("#previous").on("click",function(){
            ...
            if (pgno=='0'){
                ...
                console.log(pgno)
                window.location.replace('/practo?pgno='+pgno)
            }
        });
    });
</script>
...
<script>
    $(document).ready(function(){
        $("#next").on("click",function(){
            var pgno1='{{variable.pgno}}'
            var pgno=parseInt(pgno1)+10
            window.location.replace('/practo?pgno='+pgno)
        });
    });
</script>
